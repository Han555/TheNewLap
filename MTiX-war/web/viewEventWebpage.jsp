...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-8" style="background-color:#F1F1F1;-webkit-border-radius: 2px 2px 2px 2px;
            ...
            <div class="row" style="margin-bottom:20px">
                <div class="col-md-4" style="margin-top:15px"><img src="/MTiX-war/ContentImageController?id=<%=data.get(3)%>" width="210px" height="210px"></div>
    ...
    <div class="row" style="margin-top: 20px" >
        <div class="col-md-6 "><div class="header">
                <h5 class="title" ><b>Recommended Events (SAME TYPE)</b></h5> 
                </div><div id ="eventList"></div></div>
        <script>

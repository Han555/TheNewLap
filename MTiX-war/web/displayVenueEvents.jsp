<%-- 
    Document   : displayVenueEvents
    Created on : 4 Nov, 2016, 1:27:41 PM
    Author     : JingYing
--%>
...
<div class="container">
    <%
        ...
        String propertyName = request.getAttribute("propertyName").toString();
    %>
    ...
    <div class="panel panel-default col-lg-8" style="box-shadow: 0px 3px 10px 1px rgba(119, 119, 119, 0.75);
        ...
        <div class="check">
            ...
            <div class="row">
                    ...
                    <div class="col-md-4" style="margin-top:15px"><p>No Event Under This Venue</div>
                    <div class="col-md-4" style="margin-top:15px"></div>
            </div>

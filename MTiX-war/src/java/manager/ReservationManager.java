...
public class ReservationManager {
    ...
    public SubEvent addNewSubEvent(CompanyEntity company,String name,  String daterange, Long propertyId, Long eId, String uId,String type) throws ParseException {
        ...
        return rpb.addNewSubEvent(company,name,startDate, endDate, propertyId,eId,uId,type);

    }
    
    public Event addNewEventWithSub(CompanyEntity company,String name, String eventDes, Long eoEmail){
        return rpb.addNewEventWithSub(company,name,eventDes,eoEmail);
    }

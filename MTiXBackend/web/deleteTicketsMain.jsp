<%-- 
    Document   : deleteTicketsMain
    Created on : 4 Oct, 2016, 12:38:23 AM
    Author     : JingYing
--%>
...
<div class="container-fluid">
    ...
    %>
    <c:url var="formAction" value="/BackController?action=deleteTicketSelectSession" />
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <c:if test="${success == 'true'}">
                        <font color="red">Deleted Reserved Section Tickets</font><br/>
                    </c:if>

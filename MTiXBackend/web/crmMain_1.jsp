            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p><c:url var="linkHref" value="/BackController?action=aCRMMain" /><a href="${linkHref}" class="btn btn-primary" role="button">Enter</a> </p>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p><c:url var="linkHref" value="/BackController?action=oCRMMain" /><a href="${linkHref}" class="btn btn-primary" role="button">Enter</a> </p>
                    </div>
                </div>
            </div>
        </div>

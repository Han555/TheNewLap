<%-- 
    Document   : resumeTicketMain
    Created on : 4 Oct, 2016, 3:43:38 PM
    Author     : JingYing
--%>
...
<div class="container-fluid">
    ...
    %>
    <c:url var="formAction" value="/BackController?action=resumeTicketSelectSession" />
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <c:if test="${success == 'true'}">
                        <font color="red">Resumed Section Tickets</font><br/>
                    </c:if>

<%-- 
    Document   : oCRMMain
    Created on : Oct 25, 2016, 10:49:05 PM
    Author     : hyc528
--%>
...
<div class="container-fluid">
    <div class="page-title">
        <span class="title">Operational CRM Management Backend System</span>
    </div>
    <div class="side-body padding-top">
        <div class="row">
            <div class="col-sm-5">
                <!--    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12"> -->
                <c:url var="linkHref" value="/BackCRMController?action=oCRMLinkCard" />
                <a href="${linkHref}">
                    <div class="card green summary-inline">
                        <div class="card-body">
                            <i class="icon fa fa-share-alt fa-4x"></i>
                            <div class="content">
                                <div class="title">Link Loyalty Card Number</div>
                            </div>
            ...
            <div class="col-sm-5">
                <!--    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12"> -->
                <c:url var="linkHref" value="/BackCRMController?action=oCRMEditCustomer" />
                <a href="${linkHref}">

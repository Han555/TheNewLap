<%-- 
    Document   : deleteWebpageMain
    Created on : 15 Oct, 2016, 9:31:34 AM
    Author     : JingYing
--%>
...
<div class="container-fluid">
    ...
    %>
   <c:url var="formAction" value="/ContentBackController?action=deleteWebpage" />
            ...
            <div class="col-md-8">
                <div class="card">
                   ...
                   <c:if test="${success == 'true'}">
                        <font color="red">Webpage Deleted Successfully!</font><br/>
                    </c:if>
                            <form id="contact_form" action="${formAction}" method="POST">
                                ...
                                <%
                                    if (data.size() == 0) {
                                %>
                                <div align="center"><h5>No Webpage found! You have yet to create a Webpage for your event.</h5></div><br><br>
                                <%} else {
                                %>

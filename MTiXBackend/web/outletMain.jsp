<%-- 
    Document   : outletMain
    Created on : Sep 23, 2016, 1:45:15 AM
    Author     : hyc528
--%>
    ...
    <div class="side-body padding-top">
        <div class="row">
            <div class="col-sm-6">
                ...
                <c:url var="linkHref" value="/BackController?action=createOutlet" />
                <a href="${linkHref}">
                    <div class="card green summary-inline">
                        <div class="card-body">
                            <i class="icon fa fa-share-alt fa-4x"></i>
                            <div class="content">
                                <div class="title">Adding of Food & Beverage Outlet</div>
                            </div>
            ...
            <div class="col-sm-6">
                <!--    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12"> -->
                <c:url var="linkHref" value="/BackController?action=editOutlet" />
                <a href="${linkHref}">
                    <div class="card blue summary-inline">
                        <div class="card-body">
                            <i class="icon fa fa-share-alt fa-4x"></i>
                            <div class="content">
                                <div class="title">View, Delete & Update Food & Beverage Outlet</div>
                            </div>
                            <div class="clear-both"></div>
                        </div>
                    </div>

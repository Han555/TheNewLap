...
<div class="container-fluid">
    ...
    <div class="side-body padding-top">
        <div class="row">
            ...
            <div class="col-md-4">
                <img src="/MTiXBackend/SalesReportPieChart?totalTickets=<%=totalTickets%>&totalSoldTickets=<%=totalSoldTickets%>" width="400px" height="300px">
                <br><br>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-2 col-sm-2 col-xs-3">
                <div><a href="SalesReportPDF"><button type="button" class="btn btn-info">Generate Events Report</button></a><br><br><br></div>
                <div><img src="/MTiXBackend/SalesReportEventsBarChart" width="400px" height="300px"></div><br><br>
                <div class="card">
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="content">
                            <div align="center" class="value"><h2><b><%=sessionNo%></b></h2></div>
                        </div>
                        <div class="clear-both"></div>
                    </div>
                </div>

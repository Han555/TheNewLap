<%-- 
    Document   : resumeTicketSelectSession
    Created on : 4 Oct, 2016, 3:47:14 PM
    Author     : JingYing
--%>
...
<div class="container-fluid">
    ...
    %>
    <c:url var="formAction" value="/BackController?action=resumeSectionTickets" />
    <div class="side-body padding-top">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <div class="header">
                        <h4 class="title">Select Session to Resume Section Tickets</h4>   
                    </div>                        
                    ...
                    <form id="contact_form" action="${formAction}" method="POST">
                        ...
                        <div align="center" ><c:url var="formAction" value="/BackController" /><input type="submit" value="Select"/></div>
                            <%}%>
                    </form> 
                </div>
            </div>

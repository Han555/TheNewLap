<%-- 
    Document   : editWebpageMain
    Created on : 14 Oct, 2016, 10:04:35 PM
    Author     : JingYing
--%>
...
<div class="container-fluid">
    ...
    %>
   <c:url var="formAction" value="/ContentBackController?action=editWebpage" />
            ...
            <div class="col-md-8">
                <div class="card">
                   ...
                   <c:if test="${success == 'true'}">
                        <font color="red">Webpage Edited Successfully! Please wait for our Content Manager to review it</font><br/>
                    </c:if>
                            <form id="contact_form" action="${formAction}" method="POST">
                                ...
                                <%
                                    if (data.size() == 0) {
                                %>
                                <div align="center"><h5>No Event Found! / You have yet to create webpage for your event</h5></div><br><br>
                                <%} else {
                                %>

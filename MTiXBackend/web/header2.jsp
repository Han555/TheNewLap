                                        ...
                                        <div id="component-example" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <ul class="nav navbar-nav">
                                                    ...
                                                    <li><c:url var="linkHref" value="/BackController?action=manpowerMain"  /><a href="${linkHref}">Manpower</a>
                                                    </li>
                                                    <li><c:url var="linkHref" value="/BackController?action=equipmentMain" /><a href="${linkHref}">Equipment & Fixture</a>
                                                    </li>
                                                    <li><c:url var="linkHref" value="/BackController?action=outletMain" /><a href="${linkHref}">Food Outlets</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>

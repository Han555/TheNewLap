 ...
 */
@WebServlet(name = "UpdateSubEventController", urlPatterns = {"/UpdateSubEvent"})
public class UpdateSubEventController extends HttpServlet {
@EJB 
   private ReservePropertyBeanLocal rpbl;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (rm.editSubEventReservation(eid, ename)) {
            msg = "success";
        } else {
            msg = "conflict";
        }

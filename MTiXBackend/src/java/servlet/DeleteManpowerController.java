 ...
 * @author hyc528
 */
@WebServlet(name = "DeleteManpowerController", urlPatterns = {"/DeleteManpower"})
public class DeleteManpowerController extends HttpServlet {
@EJB

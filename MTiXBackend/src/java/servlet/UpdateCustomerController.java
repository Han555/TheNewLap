...
public class UpdateCustomerController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String cumspend = request.getParameter("cumspend");
        
        System.out.println("=====================" + cid +  cumspend+phonenum+loyaltypts);
        String msg = new String();

        if (crmsl.editCustomerInformation(cid, phonenum, Integer.valueOf(loyaltypts), Double.valueOf(cumspend))) {
            msg = "success";
        } else {
            msg = "conflict";
        }

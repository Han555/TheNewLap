 ...
 */
@WebServlet(name = "DeleteMaintenanceController", urlPatterns = {"/DeleteMaintenance"})
public class DeleteMaintenanceController extends HttpServlet {


    @EJB
    private MaintenanceBeanLocal maintenanceBeanLocal;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            if (msm.removeMaintenance(idStr)) {
                msg = "success";
            } else {
                msg = "fail";
            }
